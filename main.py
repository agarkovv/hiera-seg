...
from datasets import PascalPart
from utils import ext_transforms as et
from metrics import StreamHieraSegMetrics
...
def main():
    ...
    if opts.dataset.lower() == "pascal_part":
        opts.num_classes = 7
    ...
    # Setup dataloader
    if (opts.dataset == "pascal_part") and not opts.crop_val:
    ...
    # Set up metrics
    metrics = StreamHieraSegMetrics(opts.num_classes)
